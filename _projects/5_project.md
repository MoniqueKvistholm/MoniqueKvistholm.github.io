    ...
    <article>
      <div class="row">
        <div class="col-md-7">
          ...
          <p>The project investigates recent advancements in PET/CT scanning technology and the challenges they present. The primary focus is on using artificial intelligence to generate synthetic CT images directly from PET scan data. This method aims to replace conventional CT scans, thus reducing patient radiation exposure while preserving high image quality.</p>

          <strong>Project Background</strong>
          <p>Traditionally, PET scans require a separate CT scan to correct for attenuation, which increases the patient’s overall radiation dose. This project introduces an innovative approach where artificial intelligence is used to create synthetic CT images from PET scans that have not yet been attenuation-corrected. By eliminating the need for a separate CT scan, this method could significantly reduce the total radiation dose. The approach involves a generator that creates synthetic CT images and a discriminator that evaluates whether these images are real or synthetic. This dual setup helps improve the quality of the synthetic images.</p>
          <p>Comparisons between standard [^18F]FDG-PET images and synthetic PET images (sPET) showed that in 30 out of 36 cases, the image quality was the same, with only minor differences in six cases that did not have clinical significance.</p>

          <strong>Project Potential</strong>
          <p>The results indicate that synthetic CT images generated using advanced algorithms are almost as effective as traditional CT images, and synthetic PET images show minimal discrepancies compared to conventional PET scans. This suggests that the proposed model could be highly effective in clinical settings. 
          The approach holds potential for replacing CT scans in certain situations, significantly reducing patient radiation exposure. This is particularly important for scenarios where low radiation doses are crucial, such as in children, pregnant woman, or patients undergoing regular monitoring.</p>
        </div>
